        ...
        <div className="flex flex-col lg:flex-row items-center">
          ...
          >
            ...
            <motion.p
              ...
              className="text-xl text-gray-200 mb-8 max-w-xl mx-auto lg:mx-0 text-justify hyphens-auto sm:hyphens-none"
            >
            ...
            >
              <Link
                ...
                duration={500}
              >
                <button className="btn btn-primary bg-primary-500 hover:bg-primary-600 text-white px-4 sm:px-8 py-4 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105">
                  Get Started Free
                  <FiChevronRight className="ml-2 hidden sm:inline" />
                </button>
              </Link>
              ...
              <Link
                ...
                duration={500}
              >
                <button className="btn btn-secondary bg-white/10 backdrop-blur-sm text-white border border-white/20 hover:bg-white/20 px-4 sm:px-8 py-4 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105">
                  See How It Works
                </button>
              </Link>
            </motion.div>
          ...
          <motion.div
            ...
            className="w-full flex justify-center items-center lg:w-1/2 min-h-[300px] mt-2 sm:mt-0"
          >
            <div className="relative">
              ...
              <motion.div
                className="absolute -bottom-8 sm:-bottom-6 -left-4 sm:-left-6 bg-white/10 backdrop-blur-sm p-2 sm:p-4 rounded-xl shadow-lg border border-white/20"
              ...
              >
                <div className="flex items-center gap-1 sm:gap-3">
                  ...
                  <p className="text-xs sm:text-sm font-medium text-white">30% faster service</p>
                </div>
              </motion.div>
              
              <motion.div
                className="absolute -top-8 sm:-top-6 -right-4 sm:-right-6 bg-white/10 backdrop-blur-sm p-2 sm:p-4 rounded-xl shadow-lg border border-white/20"
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: 1, scale: 1 }}
              ...
              >
                <div className="flex items-center gap-1 sm:gap-3">
                  ...
                  <p className="text-xs sm:text-sm font-medium text-white">20% revenue increase</p>
                </div>
              </motion.div>
            </div>
          </motion.div>
